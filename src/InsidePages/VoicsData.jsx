...
<br/>
                ...
                <div id="blocks" style={{height:"73px",background:"#2a2929f8" , borderRadius:"8px"}}>
        ...
        {options.map((option, index) => (
          index !== options.length - 1 && <div key={index} className="line" />
        ))}
      </div>
                       </div>
                 </div>
...
<br/>
                 ...
                 <div id="Blocks" style={{height:"40px",marginTop:"25px"}}>
                          ...
                          <div className="Screen_View_Row" >
                                 ...
                                 <span id="Button_General" style={{marginTop:"10px"}}>VoLTE</span>
                                 <span style={{marginTop:"5px",marginRight:"10px"}}>
                                 <label className="switch">
                                 <input type="checkbox" onChange={toggleVolte} checked={isVolteOn} />

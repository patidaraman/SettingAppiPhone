 ...
 console.log(e.target.value)
  ...
  return (
    <div>
       ...
       <div className='top'>
        <div  id="button" onClick={()=>navigate(-1)}>Cancel</div> 
...
<div id="Blocks" style={{height:"45px"}} className='Screen_View_Row' >
        ...
        <input  onChange={handlePassword} style={{marginTop:"10px" , marginBottom:"10px" , marginRight:"15px" , 
...
<div >
  <span className='paragraph'> Other users will join your shared Wi-Fi network<br/> using this password.</span><br/>
  <span className='paragraph' > The password must contain at least 8 Characters. <br/> Changing the password will disconnect 

  ...
  return (
    <div>
                ...
                <div className='top'>
                      ...
                      <div style={{color:"white" ,fontSize:"20px" }}>Calender Alerts</div>
                </div>
            ...
            <br/>
                    ...
                    <div id="Blocks" style={{height:"35px"}} >
                            ...
                            <div  className="Screen_View_Row">
                              ...
                              <div className="Button_Click"  onClick={()=>navigate('/CalenderAlerts')} >Vibration</div>
                               <div style={{marginRight:"10px" , marginTop:"5px", color:"gray"}} onClick={()=>navigate('/CalenderAlerts')}> Default</div>
